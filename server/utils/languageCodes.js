module.exports = {
  ...
  ar: ["ara", "ara + 30", "Arabe", "العربية", "Arabic"],
  ...
  co: ["cos", "cos", "Corse", "Corsu ; lingua corsa", "Corsican"],
  cr: ["cre", "cre + 6", "Cri", "ᓀᐦᐃᔭᐍᐏᐣ", "Cree"],
  cs: ["cze/ces", "ces", "Tchèque", "Česky ; čeština", "Czech"],
  cu: ["chu", "chu", "Vieux-slave", "Словѣньскъ", "Old Church Slavonic"],
  ...
  dv: ["div", "div", "Maldivien", "ދިވެހި", "Divehi"],
  ...
  hz: ["her", "her", "Héréro", "Otjiherero", "Herero"],
  ...
  ik: ["ipk", "ipk + 2", "Inupiak", "Iñupiaq ; Iñupiatun", "Inupiaq"],
  ...
  kl: ["kal", "kal", "Groenlandais", "Kalaallisut ; kalaallit oqaasii", "Kalaallisut"],
  km: ["khm", "khm", "Khmer", "ភាសាខ្មែរ", "Khmer"],
  kn: ["kan", "kan", "Kannada", "ಕನ್ನಡ", "Kannada"],
  ko: ["kor", "kor", "Coréen", "한국어 (韓國語) ; 조선말 (朝鮮語)", "Korean"],
  kr: ["kau", "kau + 3", "Kanouri", "Kanuri", "Kanuri"],
  ks: ["kas", "kas", "Cachemiri", "कश्मीरी ; كشميري", "Kashmiri"],
  ...
  nd: ["nde", "nde", "Sindebele", "isiNdebele", "North Ndebele"],
  ...
  nr: ["nbl", "nbl", "Nrebele", "Ndébélé", "South Ndebele"],
  ...
  os: ["oss", "oss", "Ossète", "Ирон ӕвзаг", "Ossetian"],
  pa: ["pan", "pan", "Pendjabi", "ਪੰਜਾਬੀ ; پنجابی", "Panjabi"],
  pi: ["pli", "pli", "Pali", "पािऴ", "Pāli"],
  ...
  rc: ["rcf", "rcf", "Créole Réunionnais", "Kréol Rénioné", "Reunionese"],
  rm: ["roh", "roh", "Romanche", "Rumantsch grischun", "Romansh"],
  ...
  sh: ["", "hbs", "Serbo-croate", "srpskohrvatski jezik ; српскохрватски језик", "Serbo-Croatian"],
  si: ["sin", "sin", "Cingalais", "සිංහල", "Sinhalese"],
  sk: ["slo/slk", "slk", "Slovaque", "Slovenčina", "Slovak"],
  sl: ["slv", "slv", "Slovène", "Slovenščina", "Slovenian"],
  sm: ["smo", "smo", "Samoan", "Gagana faa Samoa", "Samoan"],
  ...
  ss: ["ssw", "ssw", "Swati", "SiSwati", "Swati"],
  ...
  ti: ["tir", "tir", "Tigrigna", "ትግርኛ", "Tigrinya"],
